...
[Authorize(Roles = "Admin")]
    public class AdministratorController : Controller
    {
        ...
        private readonly BNS_FinalContext _context;



        public AdministratorController(RoleManager<IdentityRole> roleManager, SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager, BNS_FinalContext
            context)
        {
